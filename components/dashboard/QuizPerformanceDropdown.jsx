...
const QuizPerformanceDropdown = ({
  ...
  return (
    <div className="d-flex justify-between items-center py-20 px-30 border-bottom-light">
      ...
      <div>
        <div
          className={`dropdown js-dropdown js-category-active ${darkMode ? "-dark-bg-dark-2 " : ""
            }`}
          data-select-value=""
          style={{ margin: "auto" }}
        >
          <button
            ...
            className={`dropdown__button d-flex items-center text-14 bg-white -dark-bg-dark-1 border-light rounded-8 px-20 py-10 text-14 lh-12 ${darkMode ? "-dark-bg-dark-1 -dark-border-white-10" : ""
              }`}
          >
            <span
          ...
          <div
            className={`select__dropdown js-dropdown ${darkMode ? "-dark-bg-dark-2" : ""
              } ${ddOpen ? "-is-visible" : ""}`}
              ...
              {options
                ? options.map((option, i) => (
                  <div
                    ...
                    className={`select__options__button js-target-title${selectedValue === option.label ? "-is-choosen" : ""
                      }`}
