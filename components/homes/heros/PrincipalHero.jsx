...
import hero_bg from "../../../public/assets/img/home-1/hero/bp.png";
...
const PrincipalHero = ({ clubWords, homeHeroText }) => {
    ...
    return (
        <>
            ...
            // style={{ height: "76px" }}
            >
                <div className="masthead__bg" style={{ width: '100%', height: 'auto' }} >
